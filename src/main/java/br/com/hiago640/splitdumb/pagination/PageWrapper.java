package br.com.hiago640.splitdumb.pagination;
...
public class PageWrapper<T> {
	...
	private String removeEmptyQueryParams(String queryString) {
		...
		for (String parameter : queryString.split("&")) {
			if (parameter.indexOf('=') != parameter.length() - 1) { // achou o = antes da ultima posicao, ou seja, tem valor
	...
	// Se a propriedade nao tiver uma ordenacao na URL atual, insere uma com a ordem ASC na URL.
	// Se a propriedade tiver uma ordenacao na URL atual, inverte essa ordem na URL. 
	// Nos dois casos se existir uma ordenacao anterior ela sera substituida por essa.
	...
	public String urlInvertendoDirecaoOrdem(String propriedade) {
		...
		// Nao podemos usar o mesmo uriBuilder ou entao ao carregar uma pagina o sort inserido em
		// uma coluna alteraria o uriBuilder que depois sera usado nos numeros da paginacao o que
		// colocaria a ordenacao nesses numeros mesmo que nao tenhamos clicado para ordenar ainda
	...
	// Caso a propriedade tenha uma ordem o metodo retorna o seu inverso. ASC -> DESC, DESC -> ASC.
